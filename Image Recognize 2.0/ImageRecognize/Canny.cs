...
namespace CannyEdgeDetectionCSharp
{
    ...
    class Canny 
    {
        ...
        {
            int i, j;
            var image = new Bitmap(Obj.Width, Obj.Height);
            var bitmapData1 = image.LockBits(new Rectangle(0, 0, Obj.Width, Obj.Height),
        ...
        public Bitmap DisplayImage(float[,] GreyImage)
        {
            ...
            var bitmapData1 = image.LockBits(new Rectangle(0, 0, W, H),
                                     ImageLockMode.ReadOnly, PixelFormat.Format32bppArgb);
            unsafe
            {
